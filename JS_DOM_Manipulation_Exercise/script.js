...
console.log(clearDoneBtn);

console.log("");
console.log("");
console.log("");
console.log("");
console.log("========= My data Name ========");
console.log("formElement");
console.log("inputElement");
console.log("tasksList");
console.log("counterElement");
console.log("emptyMessage");
console.log("clearDontBtn");
...
function updateCounter() {
  ...
  if(tasks.length===0){
   ...
   counterElement.textContent = count + " task(s) remaining";
...
tasksList.addEventListener("click",function(event){
   ...
   let number = clickedbtn.parentElement.dataset.id;
   
   tasks.forEach(function(e){
      if(e.id == number){
         e.done= !e.done;
         console.log(e.done);
         clickedbtn.parentElement.classList.toggle("done")
      }
...
// your code here
clearDoneBtn.addEventListener("click",function(event){
   let remainingTask = [];
   let count = 0;
   for(const task of tasks){
      count++;
      task.id=count;
      console.log(task.id + " " +task.text + " " + task.done);
      if(task.done === false){
